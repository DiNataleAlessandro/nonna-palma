      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-16">
          ...
          <div className="space-y-6 text-center md:text-left">
            ...
            <p className="text-[13px] opacity-70 leading-relaxed tracking-wide max-w-sm">
          ...
          {/* Contact Info */}
          <div className="space-y-6 text-center md:text-left">
            <h4 className="text-[11px] uppercase tracking-[0.3em] font-bold opacity-40">Contatti</h4>
            <div className="text-[14px] space-y-4 font-serif italic">
              <p className="flex items-center justify-center md:justify-start">
                <MapPin className="w-4 h-4 mr-3 text-nonna-terra" />
                <span>Corso Vittorio Emanuele, 106, 72012 Carovigno BR</span>
              </p>
              <p className="flex items-center justify-center md:justify-start">
                <Phone className="w-4 h-4 mr-3 text-nonna-terra" />
                <span>(+39) 338 5649508</span>
              </p>
              <p className="flex items-center justify-center md:justify-start">
                <Mail className="w-4 h-4 mr-3 text-nonna-terra" />
          ...
          {/* Social & Newsletter */}
          <div className="space-y-6 text-center md:text-left">
            <h4 className="text-[11px] uppercase tracking-[0.3em] font-bold opacity-40">Seguici</h4>
            <div className="flex justify-center md:justify-start space-x-8">
              <Link href="#" className="hover:text-nonna-terra transition-colors"><Instagram className="w-6 h-6" /></Link>
              <Link href="#" className="hover:text-nonna-terra transition-colors"><Facebook className="w-6 h-6" /></Link>
            </div>
            <div className="pt-4">
              <p className="text-[11px] uppercase tracking-widest opacity-60 mb-2">P.IVA 02671810741</p>
            </div>
          </div>
        </div>
